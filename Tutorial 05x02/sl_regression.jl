...
using CSV, GLM, Plots, TypedTables, DataFrames

#use CSV package to import data

data = CSV.read(raw"C:\Users\USER\Series 05\Tutorial 05x02\housingdata.csv", DataFrame)

#define x axis or features and then Y axis or label or target
...
#Use GLM for linear Regression model
